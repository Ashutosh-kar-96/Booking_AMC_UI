...
import { LOCATION_URL } from "../../services/endpoints";
import { useEffect, useState } from "react";

const Inner = () => {
 // Local state for form inputs (since we're not using useForm hook yet)
const { toastRef, showToast } = useToast();
const { get, post, put, delete: del, loading, error } = useCrud(LOCATION_URL);
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        if (editId) {
          ...
          showToast("Location update successfully!", "success");
        } else {
          // ADD
          await post("", {
            name: formData.name,
          ...
          <div className="row">
            <div className="col-12">
              <div className="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                <h4 className="mb-sm-0">Location Master</h4>
            ...
            <div className="col-lg-3">
              <div className="card shadow-sm">
                <div className="card-header bg-light">
                  <h5 className="mb-0">{editId ? "Update Location" : "Save Location"}</h5>
                </div>
            ...
            <div className="col-lg-9">
              <div className="card shadow-sm">
                ...
                <div className="card-header bg-light d-flex justify-content-between align-items-center">
                  <h5 className="mb-0">Location List ({filteredData.length} items)</h5>
                  <div className="d-flex gap-2">
                    ...
                    <button
                      ...
                      onClick={() => downloadExcel(filteredData, 'locations')}
                    >
                ...
                <div className="card-body">
                  ...
                  <DataTable
                    ...
                    noDataComponent="No locations found" // Message when no data
                  />
                </div>
              </div>
            </div>
